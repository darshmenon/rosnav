...
Usage
─────
  ros2 run rosnav_bot fleet_manager.py list
  ros2 run rosnav_bot fleet_manager.py locations
  ros2 run rosnav_bot fleet_manager.py goto robot1 room_a
  ros2 run rosnav_bot fleet_manager.py goto robot2 3.0 -1.0
  ros2 run rosnav_bot fleet_manager.py dock robot1
  ros2 run rosnav_bot fleet_manager.py undock robot1
  ros2 run rosnav_bot fleet_manager.py mission robot1 patrol room_a room_b room_c
  ros2 run rosnav_bot fleet_manager.py mission robot1 patrol 1,2,0 3,4,90
  ros2 run rosnav_bot fleet_manager.py mission robot1 goto charging_dock
...
class FleetNode(Node):
    ...
    def cmd_add(self, ns: str, x: float, y: float):
        ...
        try:
            ...
            share = os.path.join(os.path.expanduser('~'), 'rosnav', 'src', 'rosnav_bot')
        subprocess.Popen([
