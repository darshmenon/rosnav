...
─────
  ...
  # Add tasks to queue:
  ros2 run rosnav_bot task_allocator.py add 2.0 1.5 0
  ros2 run rosnav_bot task_allocator.py add 3.5 -1.0 90 dock_B

  # Check queue state:
  ros2 run rosnav_bot task_allocator.py status

  # Clear queue:
  ros2 run rosnav_bot task_allocator.py clear

  # Or via fleet_manager:
  ros2 run rosnav_bot fleet_manager.py tasks add 2.0 1.5 0
