...
from rosnav_bot.rmf.docking import get_docking_plugin
from rosnav_bot.rmf.graph_builder import build_graph
from rosnav_bot.rmf.robot_command import Nav2RobotCommand, yaw_from_quat
...
def main(argv=None) -> None:
    ...
    parser.add_argument(
        '--config', default=None,
        help='Path to rmf_fleet.yaml (default: share/rosnav_bot/config/rmf_fleet.yaml)')
