...
def generate_launch_description():
    ...
    forwarded_args = {
        ...
        'explore_bt': LaunchConfiguration('explore_bt'),
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('frontier_scorer', default_value='utility'),
        DeclareLaunchArgument('explore_bt', default_value='explore_nav'),
        DeclareLaunchArgument('distance_weight', default_value='1.0'),
        DeclareLaunchArgument('info_gain_weight', default_value='3.0'),
        DeclareLaunchArgument('potential_scale', default_value='3.0'),
        DeclareLaunchArgument('gain_scale', default_value='1.0'),
        DeclareLaunchArgument('validate_on_costmap', default_value='true'),
        DeclareLaunchArgument('costmap_max_cost', default_value='1'),
        DeclareLaunchArgument('goal_pullback', default_value='0.55'),
        DeclareLaunchArgument('hysteresis_radius', default_value='2.0'),
        DeclareLaunchArgument('hysteresis_gain', default_value='1.5'),
        DeclareLaunchArgument('frontier_clearance_radius', default_value='0.55'),
